...
export default function Home({ posts }) {
  return (
    <div>
      <NextSeo
        title={`Gaming - Tony and Peter`}
        description={`The Gaming Page of Tony and Peter, a pop culture madhouse, containg the best stories from the world of video games.`}
      />
      <Navbar />
      <h2 className={styles.heading}>Gaming</h2>
