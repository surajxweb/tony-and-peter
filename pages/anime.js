...
export default function Home({ posts }) {
  return (
    <div>
      <NextSeo
        title="Anime - Tony and Peter: Your Pop Culture Madhouse"
        description="Welcome to Tony and Peter: Your Pop Culture Madhouse, your ultimate destination for everything pop culture! Immerse yourself in a vibrant world where we explore the realms of movies, TV shows, comics, music, anime and more. Dive into captivating discussions, insightful reviews, and entertaining analyses of the latest trends and timeless classics. Join us on this exhilarating journey through the pop culture universe, where every click opens the door to a madhouse of excitement, nostalgia, and endless entertainment. Get ready to be swept away by the dynamic duo's passion for all things pop culture. Your adventure starts here!"
...
export async function getStaticProps() {
  ...
  const query = gql`
    query Marvel {
      posts(where: { category: "Anime" }, orderBy: createdAt_DESC) {
        id
        title
        slug
        coverPhoto {
