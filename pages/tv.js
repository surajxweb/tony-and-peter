...
export default function Home({ posts }) {
  return (
    <div>
      <Navbar />
      <NextSeo
        title={`TV - Tony and Peter`}
        description={`The TV Page of Tony and Peter, a pop culture madhouse, containg the best stories from the world of TV Shows.`}
      />
